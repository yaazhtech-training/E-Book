    ...
    <header className="bg-[#66FCF1] text-[#1F2833] p-5">
      ...
      <div className="container mx-auto flex justify-between items-center"> 
        ...
        <nav className="hidden md:flex basis-2/3 font-bold justify-around items-center">
          ...
          <a href="/" className="hover:text-white"><script>'./Banner.jsx'</script>Home</a>
          ...
          <a href="/upload" className="block py-2 hover:text-gray-300"> <script>'./Upload.jsx'</script>Upload</a>
          <button className="px-4 py-1 bg-[#52585f] text-white rounded-sm font-bold">
            <a href="/authform" className=""> <script>'./AuthFrom.jsx'</script>Login </a>
               <span> | </span>
            <a href="/Signup" className=""> <script>'./Signup.jsx'</script>Sign up</a>
          </button>
      ...
      {Open && (
        <nav className="md:hidden bg-blue-600 text-white p-3 mt-2">
          ...
          <a href="/contact" className="block py-2 hover:text-gray-300">Upload</a>
          <button className="px-4 py-1 bg-[#52585f] text-white rounded-sm font-bold">
