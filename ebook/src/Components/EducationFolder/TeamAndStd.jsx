            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 p-5">
              {books
                ...
                .map((subject, index) => (
                  <div 
                    key={index} 
                    className="bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition transform hover:scale-105 border border-gray-200 w-64"
                  >
                    {/* Image */}
                    <img 
                      src={subject.image} 
                    ...
                    {/* Title */}
                    <h1 className="text-black font-bold mt-3 text-center text-lg">
                      {subject.name}
                    </h1>
                    ...
                    <button
                      ...
                      className="mt-3 w-full py-2 bg-[#66FCF1] text-[#1F2833] rounded-lg font-bold hover:bg-[#45E0D3] transition duration-300 shadow-md"
                    >
                      Read Chapter
                    </button>
                  </div>
              ...
              {books
                .filter(
                  (book) =>
                    ...
                    (!isCBSE || book.name === selectedSubject) // Show only selected subject's chapters
                )
                .map((book, index) => (
                  <div
                    key={index}
